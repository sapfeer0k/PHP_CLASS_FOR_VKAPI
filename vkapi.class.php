...
class VK {
	...
	function api($method,$params=false) {
		...
		$params['sig'] = md5($sig);
		$res = $this->sendPost($this->api_url,$this->params($params),'http://vk.com/app'.$this->app_id.'_'.$this->app_id);
    ...
    private function sendPost($post_url, $post_data, $refer) 
    { 
        $ch = curl_init(); 
